...
I Nav-tjenesten er utdatene organisert etter alder, ikke dato. Dermed må tallene regnes om slik at de gjelder for den enkelte alder. Start og slutt på hver 12-månedersperiode blir da bestemt av fødselsdatoen og ikke av kalenderårets start/slutt.
