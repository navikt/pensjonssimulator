...
// PEN: no.nav.domain.pensjon.kjerne.kodetabeller.SimuleringTypeCode
enum class TpoFolketrygdberegnetAfpSimuleringTypeSpecV0(val externalValue: String, val internalValue: SimuleringType) {
    /**
     * AFP
     */
    ...
    companion object {
        ...
        fun fromExternalValue(value: String?): TpoFolketrygdberegnetAfpSimuleringTypeSpecV0 =
            entries.singleOrNull { it.externalValue.equals(value, true) } ?: default(value)

        private fun default(externalValue: String?): TpoFolketrygdberegnetAfpSimuleringTypeSpecV0 =
