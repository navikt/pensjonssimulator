...
import no.nav.pensjon.simulator.api.nav.v2.acl.spec.SimuleringSpecDto
import no.nav.pensjon.simulator.api.nav.v2.acl.spec.SimuleringSpecMapperForNavV2
import no.nav.pensjon.simulator.api.nav.v2.acl.result.ProblemDto
import no.nav.pensjon.simulator.api.nav.v2.acl.result.ProblemTypeDto
import no.nav.pensjon.simulator.api.nav.v2.acl.result.SimuleringResultDto
import no.nav.pensjon.simulator.api.nav.v2.acl.result.SimuleringResultMapper
import no.nav.pensjon.simulator.api.nav.v2.acl.result.VilkaarsproevingsresultatDto
 ...
 */
@RestController
@RequestMapping("api/nav/v2")
@SecurityRequirement(name = "BearerAuthentication")
class PensjonForNavV2Controller(
    private val service: SimuleringFacade,
    private val specMapper: SimuleringSpecMapperForNavV2,
