...
class Familietillegg : Ytelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("FAM_T"))

    constructor(familietillegg: Int) : this() {
        netto = familietillegg
    }

    constructor(Familietillegg: Familietillegg) : super(Familietillegg) {}
    ...
    constructor(
        ...
        ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("FAM_T"),
