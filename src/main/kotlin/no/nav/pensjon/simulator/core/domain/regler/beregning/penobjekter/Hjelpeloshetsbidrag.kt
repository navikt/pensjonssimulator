...
class Hjelpeloshetsbidrag : Ytelseskomponent {
    ...
    constructor(hjelpeloshetsbidrag: Hjelpeloshetsbidrag) : super(hjelpeloshetsbidrag) {
    ...
    constructor(
            ...
            ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("HJELP_BIDRAG"),
