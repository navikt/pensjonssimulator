...
class SkattefriGrunnpensjon : BeregningYtelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("SKATT_F_GP"))

    constructor(skattefriGrunnpensjon: SkattefriGrunnpensjon) : super(skattefriGrunnpensjon) {
        pensjonsgrad = skattefriGrunnpensjon.pensjonsgrad
    }
    ...
    constructor(
        ...
        ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("SKATT_F_GP"),
