...
class SkattefriUforetrygdOrdiner : BeregningYtelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("SKATT_F_UT_ORDINER"))

    constructor(original: SkattefriUforetrygdOrdiner) : super(original) {
    ...
    constructor(
        ...
        ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("SKATT_F_UT_ORDINER"),
