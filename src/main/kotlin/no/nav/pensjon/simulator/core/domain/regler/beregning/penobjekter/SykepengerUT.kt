...
class SykepengerUT : MotregningYtelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("UT_SP")) {

    }

    constructor(sykepengerUT: SykepengerUT) : super(sykepengerUT)
    ...
    constructor(
        ...
        ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("UT_SP"),
