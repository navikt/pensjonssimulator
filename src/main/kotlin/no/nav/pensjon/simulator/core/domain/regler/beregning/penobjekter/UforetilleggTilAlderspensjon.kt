...
class UforetilleggTilAlderspensjon : Ytelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("UFORETILLEGG_AP"))

    constructor(src: UforetilleggTilAlderspensjon) : super(src) {
    ...
    constructor(
            ...
            ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("UFORETILLEGG_AP"),
