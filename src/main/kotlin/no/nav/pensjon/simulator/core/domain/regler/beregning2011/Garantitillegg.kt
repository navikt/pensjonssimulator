...
class Garantitillegg : Ytelseskomponent {
    ...
    constructor() : super(ytelsekomponentType = YtelsekomponentTypeCti("GAT"))
    constructor(gt: Garantitillegg) : super(gt) {
    ...
    constructor(
            ...
            ytelsekomponentType: YtelsekomponentTypeCti = YtelsekomponentTypeCti("GAT"),
