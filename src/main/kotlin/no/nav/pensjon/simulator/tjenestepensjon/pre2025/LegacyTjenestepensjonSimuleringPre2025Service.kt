...
@Component
class LegacyTjenestepensjonSimuleringPre2025Service(
    ...
    companion object {
        ...
        private fun ikkeMedlem() =
            SimulerOffentligTjenestepensjonResult("", "", emptyList(), brukerErIkkeMedlemAvTPOrdning = true)

        private fun tpOrdningStoettesIkke(relevanteTpOrdninger: List<String>? = null) =
            SimulerOffentligTjenestepensjonResult(
                "",
                "",
                emptyList(),
                brukerErMedlemAvTPOrdningSomIkkeStoettes = true,
                relevanteTpOrdninger = relevanteTpOrdninger ?: emptyList()
            )
    }
}