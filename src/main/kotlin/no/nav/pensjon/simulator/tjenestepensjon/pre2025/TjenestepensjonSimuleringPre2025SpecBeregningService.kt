...
@Service
class TjenestepensjonSimuleringPre2025SpecBeregningService(private val simulator: SimulatorCore) {

    fun kompletterMedAlderspensjonsberegning(simuleringSpec: SimuleringSpec, stillingsprosentSpec: StillingsprosentSpec): TjenestepensjonSimuleringPre2025Spec {
        val simuleringResultat = simulator.simuler(simuleringSpec)
        return aggregateSpec(simuleringResultat, simuleringSpec, stillingsprosentSpec)
    }
}