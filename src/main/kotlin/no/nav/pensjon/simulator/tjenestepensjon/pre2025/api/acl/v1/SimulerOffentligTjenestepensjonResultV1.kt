...
data class SimulerOffentligTjenestepensjonResultV1(
    ...
    data class UtbetalingsperiodeV1(
        ...
        var ytelsekode: YtelseCodeV1?
    )

    enum class YtelseCodeV1 {
        AP,
        AFP,
        SERALDER
    }
...
enum class FeilkodeV1(val externalValues: List<String>, val externalErrorMessages: List<String>) {
