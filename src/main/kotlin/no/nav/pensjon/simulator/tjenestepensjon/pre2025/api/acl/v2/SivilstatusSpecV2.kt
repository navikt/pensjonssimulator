...
enum class SivilstatusSpecV2(val externalValue: String, val internalValue: SivilstatusType) {
    /**
     * Enke/-mann
     */
    ...
    companion object {
        ...
        fun fromExternalValue(value: String?): SivilstatusSpecV2 =
            entries.singleOrNull { it.externalValue.equals(value, true) } ?: default(value)

        private fun default(externalValue: String?): SivilstatusSpecV2 =
            if (hasLength(externalValue))
                UGIF.also { log.warn { "Unknown NavSivilstandSpecV2: '$externalValue'" } }
            else
                UGIF
    }
}
