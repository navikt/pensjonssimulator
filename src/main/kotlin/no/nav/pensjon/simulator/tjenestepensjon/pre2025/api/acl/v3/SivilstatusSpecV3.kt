...
enum class SivilstatusSpecV3(val externalValue: String, val internalValue: SivilstatusType) {
    /**
     * Enke/-mann
     */
    ...
    companion object {
        ...
        fun fromExternalValue(value: String?): SivilstatusSpecV3 =
            entries.singleOrNull { it.externalValue.equals(value, true) } ?: default(value)

        private fun default(externalValue: String?): SivilstatusSpecV3 =
