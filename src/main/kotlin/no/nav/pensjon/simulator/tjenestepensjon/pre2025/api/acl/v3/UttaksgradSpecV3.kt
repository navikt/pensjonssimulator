...
enum class UttaksgradSpecV3(@get:JsonValue val externalValue: String, val internalValue: UttakGradKode) {
    /**
     * 0 %
     */
    ...
    companion object {
        ...
        fun toInt(v: UttaksgradSpecV3?) = v?.externalValue?.toInt() ?: 100
    }
}
