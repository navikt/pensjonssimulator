        ...
        NavSimuleringResultMapperV3.toDto(
            SimulertPensjonEllerAlternativ(
                pensjon = SimulertPensjon(
                    ...
                    privatAfp = listOf(SimulertPrivatAfp(alderAar = 66, beloep = 789, kompensasjonstillegg = 123, kronetillegg = 69, livsvarig = 321, maanedligBeloep = 100)),
            ...
            privatAfpListe = listOf(NavPrivatAfpV3(alderAar = 66, beloep = 789, kompensasjonstillegg = 123, kronetillegg = 69, livsvarig = 321, maanedligBeloep = 100)),
