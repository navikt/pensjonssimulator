...
class Kapittel20TrygdetidsgrunnlagCreatorTest : FunSpec({
     ...
     * - siste trygdetidsdato = dagen før uttaksstart, begrenset oppad til 31.12. året brukeren blir 66 år
     */
    test("kapittel20TrygdetidsperiodeListe gir siste trygdetidsdato = dagen før uttaksstart") {
        val result = Kapittel20TrygdetidsgrunnlagCreator.kapittel20TrygdetidperiodeListe(
            spec = simuleringSpec(
                type = SimuleringTypeEnum.ALDER,
                foersteUttakDato = LocalDate.of(2033, 7, 1),
                heltUttakDato = null,
